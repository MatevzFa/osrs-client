...
import com.matevzfa.osrsclient.logic.Calculate;
import com.matevzfa.osrsclient.logic.RuneScapeAccount;
import net.miginfocom.swing.MigLayout;
import org.pushingpixels.trident.Timeline;
import com.matevzfa.osrsclient.rsclient.coregui.LengthRestrictedDocument;
...
public class HiscoresPanel extends JPanel implements StatRolloverListener {
    ...
    private void setup() {
        ...
        searchButton.setIcon(new javax.swing.ImageIcon(getClass().getClassLoader().getResource("searchiconsquare3.png")));
        //searchButton.setIcon(new javax.swing.ImageIcon(getClass().getClassLoader().getResource("bwsearch2.png")));
