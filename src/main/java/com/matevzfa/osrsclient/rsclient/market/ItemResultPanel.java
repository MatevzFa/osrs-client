...
import com.matevzfa.osrsclient.logic.ZybezItemListing;
import com.matevzfa.osrsclient.logic.ZybezOffer;
...
public class ItemResultPanel extends JPanel implements MouseListener {
    ...
    private final ImageIcon emptyItem = new ImageIcon(getClass().getClassLoader().getResource("emptyitem.png"));
